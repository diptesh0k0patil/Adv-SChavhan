...
import { FiArrowRight, FiShield, FiHome, FiBriefcase, FiUsers, FiBookmark, FiHeart, FiCheck, FiAward } from 'react-icons/fi';
...
const getIcon = (iconName, className = "w-6 h-6") => {
  switch (iconName) {
    ...
    case 'FiBriefcase': return <FiBriefcase className={className} />;
    case 'FiUsers': return <FiUsers className={className} />;
    case 'FiBookmark': return <FiBookmark className={className} />;
    case 'FiHeart': return <FiHeart className={className} />;
    default: return <FiShield className={className} />;
  }
};

export default function Home() {
  // Motion container and item presets
  ...
  return (
    <div className="overflow-hidden">
      <SEO 
        title="Home"
        description="Premium legal services & consultation before the High Court of Bombay. Advocate Shankar Chavan specializes in Criminal Defense, Civil Litigation, and Corporate Law with dedication and integrity."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              >
                Upholding <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-200 via-accent-300 to-accent-500">Justice</span> &amp; Securing Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-200 to-accent-400">Rights</span>
              </motion.h1>
            ...
            <div className="lg:col-span-5 flex justify-center">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-white">Rule of Law</h3>
                  <p className="text-sm text-slate-300 font-light leading-relaxed">
                    "Justice is not achieved by power alone; it is achieved through courage, integrity, and unwavering dedication to truth."
                  </p>
                </div>
                ...
                <div className="glass-card-dark rounded-xl p-4 border border-white/5 space-y-2 relative z-10">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-xs text-slate-300 font-sans">Active Chamber Consultation</span>
                  </div>
                  <p className="text-xs text-slate-400">Bombay High Court Principal Bench, Fort, Mumbai</p>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-slate-200 bg-slate-100 aspect-[4/5] shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 text-white">
                  <h4 className="font-serif font-bold text-lg">{ADVOCATE_INFO.name}</h4>
                  <p className="text-xs text-accent-300 font-sans tracking-wide uppercase mt-1">High Court Advocate &amp; SPP (Former)</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-sm text-slate-500 font-sans leading-relaxed">
              We specialize in resolving high-stakes challenges by combining thorough statute analysis, persuasive argument drafting, and strict professional ethics.
            </p>
          </div>
            ...
            {PRACTICE_AREAS.map((area) => (
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-slate-100 flex flex-wrap gap-2">
                  {area.features.slice(0, 2).map((feat, i) => (
                    <span 
                      key={i} 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-slate-300 font-sans text-sm leading-relaxed">
                By taking a meticulous, tech-enabled and highly analytical approach, we bridge the gap between traditional law processes and modern premium advisory.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-serif font-bold text-white text-base">Uncompromising Ethics</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                    We guard our clients' confidentiality and reputation above all else, maintaining absolute compliance and fiduciary integrity.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-sm text-slate-500">
              Here is what some of our distinguished clients say about the quality, diligence, and professionalism of our legal consultations.
            </p>
          </div>
            ...
            {TESTIMONIALS.map((t, index) => (
              ...
              >
                ...
                <div className="flex items-center space-x-3 border-t border-slate-200/60 pt-4">
                  ...
                  <div>
                    <h4 className="text-slate-900 font-semibold font-serif text-sm">{t.author}</h4>
                    <p className="text-xs text-slate-400 font-sans mt-0.5">{t.role} &bull; {t.location}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            {GALLERY_IMAGES.slice(0, 4).map((img) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4 flex flex-col justify-end text-white">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-accent-300">{img.category}</span>
                  <h4 className="text-xs font-serif font-semibold mt-1">{img.title}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary-900 to-primary-950 text-white relative">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10 space-y-6">
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed font-sans">
            Need urgent guidance on anticipatory bail, a pending property suit, startup compliance advisory, or high-stake civil litigations? Secure professional representational advice today.
          </p>
